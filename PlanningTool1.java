...
public class PlanningTool1 extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("PlanningTool");
    ...
    //public void start(Stage myStage) {
        //primaryStage.setTitle("Tasking Expressions");
        ...
        Text scenetitle1 = new Text("Tasking Expressions");
        scenetitle1.setFont(Font.font("Tahoma", FontWeight.NORMAL, 20));
        grid.add(scenetitle1, 0, 0, 2, 1);

        Label userName1 = new Label("Plan Identifier:");
        ...
        Button btn1 = new Button("Submit Tasking Expressions");
        ...
        actiontarget1.setText("Tasking Expression Submitted");
        }
        });
