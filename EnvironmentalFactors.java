 ...
 * @author DrSMarkham
 */
public class EnvironmentalFactors extends Application{
    ...
    public void start(Stage myStage){
        ...
        myStage.setTitle("EnvironmentalFactors");
        ...
        response = new Label("Environmental Factors");
        
        //Create button that gets the text
        Button btnGetText = new Button("Input Environmental Factors");
        
        tf = new TextField();
        tf.setPromptText("Input Environmental Factors as a list separated by comma space pairs");
        ...
        tf.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(ActionEvent ae){
                response.setText("Environmental Factors" + tf.getText());
            }
        });
